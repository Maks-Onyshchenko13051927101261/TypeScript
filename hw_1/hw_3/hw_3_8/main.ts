...
type addressType = {street: string, suite: string, city: string, zipcode: string, geo:geoType};
type companyType = {name: string, catchPhrase: string, bs:string};
type userType = {id: number, name: string, username: string, email:string, address:addressType, phone:string,website:string,company:companyType};
