type userUsers = {name: string, username: string, password: string};

let user1:userUsers = {name: "Zinaida", username: "Zina", password: "2314556"};
let user2:userUsers = {name: "Hrystya", username: "Kris", password: "369745"}
let users:userUsers[] = [
