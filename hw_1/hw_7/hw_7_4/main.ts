...
let clients = [
    ...
    new Client(2, "Andriy", "Yarmolenko", "yarmola@com.ua", "+3698521472558",
        [new Product("desktop", 120000), new Product("tv", 36000), new Product("sale", 0), new Product("insurance", 1500), new Product("bonus-product", 0)]),
    ...
    new Client(5, "Hrystyna", "Zelinska", "kris@com.ua", "+125463987452",
        [new Product("tv", 325000), new Product("monitor", 21300), new Product("computer", 44444), new Product("bonus-product", 0)]),
    ...
    new Client(8, "Sergiy", "Rebrov", "rebrov@com.ua", "+380954566547",
        [new Product("phone", 83800), new Product("insurance", 1300)]),
    new Client(9, "Oleh", "Gusev", "gus@com.ua", "+380502587419",
        [new Product("desktop", 54350), new Product("laptop", 31100), new Product("tablet", 23500), new Product("tv", 34600), new Product("sale", 0)]),
    new Client(10, "Georgiy", "Buschan", "zhora@com.ua", "+196325874125",
        [new Product("tablet", 43999), new Product("playstation", 25500), new Product("tv", 65999), new Product("sale", 0)])
];
